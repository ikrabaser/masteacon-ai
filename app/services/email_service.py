    ...
    async def send_verification_email(
        ...
        *,
        ...
        try:
            ...
            # Delivery failures are logged, never raised — registration must not
            # fail just because the verification email couldn't be sent.
            logger.warning("Failed to send verification email via Resend: %s", exc)
            return False
